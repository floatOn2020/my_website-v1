    ...
    }( "undefined" != typeof window ? window : this, function ( n, r )
    {
        ...
        add: function ( t, e, n, i, o )
        {
          ...
          if ( m )
            for ( n.handler && ( r = n, n = r.handler, o = r.selector ), o && yt.find.matchesSelector( Zt, o ), n.guid || ( n.guid = yt.guid++ ), ( l = m.events ) || ( l = m.events = {} ), ( s = m.handle ) || ( s = m.handle = function ( e )
              ...
              } ), e = ( e || "" ).match( It ) || [ "" ], u = e.length; u--; ) a = ne.exec( e[ u ] ) || [], d = g = a[ 1 ], h = ( a[ 2 ] || "" ).split( "." ).sort(), d && ( f = yt.event.special[ d ] ||
            {}, d = ( o ? f.delegateType : f.bindType ) || d, f = yt.event.special[ d ] ||
            {}, c = yt.extend(
            {
              type: d,
              origType: g,
            ...
            for ( e = ( e || "" ).match( It ) || [ "" ], u = e.length; u--; )
              if ( a = ne.exec( e[ u ] ) || [], d = g = a[ 1 ], h = ( a[ 2 ] || "" ).split( "." ).sort(), d )
              {
                for ( f = yt.event.special[ d ] ||
                  {}, d = ( i ? f.delegateType : f.bindType ) || d, p = l[ d ] || [], a = a[ 2 ] && new RegExp( "(^|\\.)" + h.join( "\\.(?:.*\\.|)" ) + "(\\.|$)" ), s = r = p.length; r--; ) c = p[ r ], !o && g !== c.origType || n && n.guid !== c.guid || a && !a.test( c.namespace ) || i && i !== c.selector && ( "**" !== i || !c.selector ) || ( p.splice( r, 1 ), c.selector && p.delegateCount--, f.remove && f.remove.call( t, c ) );
      ...
      yt.extend( yt.event,
      {
        trigger: function ( t, e, i, o )
        {
            ...
            {}, o || !f.trigger || !1 !== f.trigger.apply( i, e ) ) )
          {
            ...
            for ( r = 0;
              ( s = p[ r++ ] ) && !t.isPropagationStopped(); ) t.type = r > 1 ? l : f.bindType || d, c = ( Ht.get( s, "events" ) ||
            {} )[ t.type ] && Ht.get( s, "handle" ), c && c.apply( s, e ), ( c = u && s[ u ] ) && c.apply && Pt( s ) && ( t.result = c.apply( s, e ), !1 === t.result && t.preventDefault() );
      ...
      _e.href = $e.href, yt.extend(
      {
        ...
        ajax: function ( t, e )
        {
          ...
          {};
          var o, r, s, a, l, u, c, f, p, d, h = yt.ajaxSetup(
            {}, e ),
            g = h.context || h,
      ...
      } ), yt.expr.pseudos.animated = function ( t )
      {
        ...
        setOffset: function ( t, e, n )
        {
          var i, o, r, s, a, l, u, c = yt.css( t, "position" ),
            f = yt( t ),
            p = {};
          "static" === c && ( t.style.position = "relative" ), a = f.offset(), r = yt.css( t, "top" ), l = yt.css( t, "left" ), u = ( "absolute" === c || "fixed" === c ) && ( r + l ).indexOf( "auto" ) > -1, u ? ( i = f.position(), s = i.top, o = i.left ) : ( s = parseFloat( r ) || 0, o = parseFloat( l ) || 0 ), yt.isFunction( e ) && ( e = e.call( t, n, yt.extend(
